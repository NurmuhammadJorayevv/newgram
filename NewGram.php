...
define('AlijonovUz',"6652055877:AAEElLAnSQyfvVxgOm4n1Rm29gmPP5PQCxM");
$AlijonovUz = "ADMIN_ID";
...
if($text){
$kun = mysqli_fetch_assoc(mysqli_query($connect,"SELECT*FROM kunlik WHERE user_id=$AlijonovUz"))['kun'];
